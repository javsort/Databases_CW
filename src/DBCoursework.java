...
/*
 * This is a program made for my Databases Coursework
 * The program reads data from CSV files, creates tables in a SQLite database, uploads the data to the tables and performs queries on the data.
 * The program uses the CSV_Reader class to read the CSV files and the UploadToDB class to upload the data to the database.
 * The program performs 14 queries on the data and prints the results to the console.
 *
 * References:
